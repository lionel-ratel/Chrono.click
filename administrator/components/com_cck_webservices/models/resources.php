...
// Model
class CCK_WebservicesModelResources extends ListModel
{
	// __construct
	...
	protected function getListQuery()
	{
		...
		// From
		$query->from( '`#__cck_more_webservices_resources` AS a' );
		...
		if ( $this->state->get( 'list.ordering', 'a.title' ) == 'a.title' ) {
			$query->order( $db->escape( 'a.type'.' '.$this->state->get( 'list.direction', 'ASC' ) ) );
			$query->order( $db->escape( 'a.methods'.' '.$this->state->get( 'list.direction', 'ASC' ) ) );
		}
