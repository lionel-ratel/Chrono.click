...
class LoadBuilderConfig
{
    ...
    /**
     * @return array<string, array{label: string, fieldset: array<string, mixed>}>
     */
     ...
     */
    protected static function getCategoryField(string $categories = 'categories'): array
    {
        return [
     ...
     * @return array<string, mixed>
     */
    protected static function getIncludeChildTagsField(string $description): array
    {
        return [
            'type' => 'select',
            'description' => $description,
