...
// Plugin
class plgCCK_FieldUikit_Icon extends JCckPluginField
{
	protected static $type		=	'uikit_icon';
	...
	public function onCCK_FieldPrepareContent( &$field, $value = '', &$config = array() )
	{
		...
		if ( $field->label !== '' ) {
			$tooltip	=	' uk-tooltip="title: '.$field->label.'; pos: '.$options2['position'].'; offset: 12"';
		}

		if ( $field->markup_class !== '' ) {
			$class	=	' class="'.$field->markup_class.'"';
		}

		$html	=	'<span uk-icon="'.$value.'"'.$class.$tooltip.'></span>';
	...
	public function onCCK_FieldPrepareForm( &$field, $value = '', &$config = array(), $inherit = array(), $return = false )
	{
		...
		$form			=	'<span uk-icon="'.$value.'"'.$class.$tooltip.'></span>';
