...
// View
class CCK_ExporterViewCCK_Exporter extends JCckBaseLegacyView
{
	// display
	...
	protected function prepareToolbar()
	{
		...
		if ( $canDo->get( 'core.admin' ) ) {
			if ( ComponentHelper::getParams( 'com_cck_exporter' )->get( 'output', 0 ) < 2 ) {
		...
		$bar->appendButton( 'CckLink', 'archive', Text::_( 'COM_CCK_SESSIONS' ), Route::_( 'index.php?option=com_cck&view=sessions&extension=com_cck_exporter' ), '_self' );
