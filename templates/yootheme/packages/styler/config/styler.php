...
return [
    ...
    'components' => [
        ...
        'theme' => [
            ...
            'hover' =>
                '.tm-page, .tm-toolbar, .tm-sidebar, .tm-headerbar-top, .tm-headerbar-bottom, .tm-headerbar-stacked, .tm-section-title, .tm-box-decoration-default, .tm-box-decoration-primary, .tm-box-decoration-secondary, .tm-transition-border',
            'inspect' =>
                '.tm-page-container, .tm-page, tm-page > *, .tm-toolbar, .tm-toolbar > *, .tm-sidebar, .tm-sidebar > *, .tm-headerbar-top, .tm-headerbar-top > *, .tm-headerbar-bottom, .tm-headerbar-bottom > *, .tm-headerbar-stacked, .tm-headerbar-stacked > *, .tm-section-title, .tm-section-title > *, .tm-box-decoration-default, .tm-box-decoration-default > *, .tm-box-decoration-primary, .tm-box-decoration-primary > *, .tm-box-decoration-secondary, .tm-box-decoration-secondary > *, .tm-transition-border, .tm-transition-border > *',
        ],
        'inverse' => [
            'name' => 'Inverse',
            'general' => true,
            'groups' => [
                ...
                'woocommerce' => '@inverse-woocommerce-*',
                'accordion default' => '@inverse-accordion-default-*',
                ...
                'icon overlay' => '@inverse-icon-overlay-*',
                ...
                'search medium' => '@inverse-search-medium-*',
        ...
        'accordion' => [
            'name' => 'Accordion',
            'groups' => [
                'default item' => '@accordion-default-item-*',
                'default title' => '@accordion-default-title-*',
                'default icon' => '@accordion-default-icon-*',
                'default content' => '@accordion-default-content-*',
            ],
            'hover' => '.uk-accordion',
            'inspect' =>
                '.uk-accordion, .uk-accordion-title, .uk-accordion-title > *, .uk-accordion-content, .uk-accordion-content > *, .uk-accordion-icon, .uk-accordion-icon > svg',
        ],
        'alert' => [
            'name' => 'Alert',
            'groups' => [
        ...
        'article' => [
            ...
            'hover' => '.uk-article',
            'inspect' =>
                '.uk-article, .uk-article > *, .uk-article-title, .uk-article-title > *, .uk-article-meta, .uk-article-meta > *',
        ],
        'background' => [
            'name' => 'Background',
            'groups' => [
        ...
        'base' => [
            ...
            'hover' =>
                'a, strong, code, kbd, samp, em, ins, mark, q, small, p, ul, ol, dl, pre, address, fieldset, figure, h1, h2, h3, h4, h5, h6, hr, blockquote, .uk-h1, .uk-h2, .uk-h3, .uk-h4, .uk-h5, .uk-h6, .uk-link',
            'inspect' =>
        ...
        'card' => [
            ...
            'groups' => [
                ...
                'overlay title' => '@card-overlay-title-*',
                'small' => '@card-small-*',
                'large' => '@card-large-*',
            ],
            'hover' => '.uk-card',
        ...
        'comment' => [
            ...
            'hover' => '.uk-comment',
            'inspect' =>
                '.uk-comment, .uk-comment-body, .uk-comment-body > *, .uk-comment-header, .uk-comment-header > *, .uk-comment-title, .uk-comment-title > *, .uk-comment-meta, .uk-comment-meta > *, .uk-comment-avatar, .uk-comment-avatar > *, .uk-comment-list, .uk-comment-list ul, .uk-comment-list li, .uk-comment-primary, uk-comment-primary > *',
        ],
        'container' => [
            'name' => 'Container',
            'groups' => [
        ...
        'description-list' => [
            ...
            'inspect' =>
                '.uk-description-list, .uk-description-list > dt, .uk-description-list > dd',
        ],
        'divider' => [
            'name' => 'Divider',
            'groups' => [
        ...
        'drop' => [
            'name' => 'Drop',
            'groups' => [
                'parent icon' => '@drop-parent-icon-*',
            ],
            'hover' => '.uk-drop',
            'inspect' => '.uk-drop, .uk-drop > *, .uk-drop-grid, .uk-drop-grid > *, .uk-drop-parent-icon, .uk-drop-parent-icon > svg',
        ],
        'dropdown' => [
            'name' => 'Dropdown',
            'groups' => [
            ...
            'hover' => '.uk-dropdown',
            'inspect' =>
                '.uk-dropdown, .uk-dropdown > *, .uk-dropdown-nav, .uk-dropdown-nav > *, .uk-dropdown-nav > * > *',
        ],
        'dropbar' => [
            'name' => 'Dropbar',
            'groups' => [
        ...
        'heading' => [
            ...
            'groups' => [
                ...
                '3xlarge' => '@heading-3xlarge-*',
                'divider' => '@heading-divider-*',
                'bullet' => '@heading-bullet-*',
                'line' => '@heading-line-*',
            ],
            'hover' =>
                '.uk-heading-small, .uk-heading-medium, .uk-heading-large, .uk-heading-xlarge, .uk-heading-2xlarge, .uk-heading-3xlarge, .uk-heading-divider, .uk-heading-bullet, .uk-heading-line',
            'inspect' =>
                '.uk-heading-small, .uk-heading-small > *, .uk-heading-medium, .uk-heading-medium > *, .uk-heading-large, .uk-heading-large > *, .uk-heading-xlarge, .uk-heading-xlarge > *, .uk-heading-2xlarge, .uk-heading-2xlarge > *, .uk-heading-3xlarge, .uk-heading-3xlarge > *, .uk-heading-divider, .uk-heading-divider > *, .uk-heading-bullet, .uk-heading-bullet > *, .uk-heading-line, .uk-heading-line > *',
        ],
        'height' => [
            'name' => 'Height',
            'hover' => '.uk-height-small, .uk-height-medium, .uk-height-large',
            'inspect' =>
                '.uk-height-small, .uk-height-small > *, .uk-height-medium, .uk-height-medium > *, .uk-height-large, .uk-height-large > *',
        ],
        'icon' => [
            'name' => 'Icon',
            'groups' => [
        ...
        'iconnav' => [
            ...
            'groups' => [
                'item' => '@iconnav-item-*',
                'siblings' => '@iconnav-siblings-*',
            ],
            'hover' => '.uk-iconnav',
            'inspect' =>
                '.uk-iconnav, .uk-iconnav > *, .uk-iconnav > * > *, .uk-iconnav > * > * > *',
        ],
        'label' => [
            'name' => 'Label',
            'groups' => [
        ...
        'nav' => [
            ...
            'groups' => [
                ...
                'default item line' => '@nav-default-item-line-*',
                'default siblings' => '@nav-default-siblings-*',
                'primary' => '@nav-primary-*',
                ...
                'primary item line' => '@nav-primary-item-line-*',
                'primary siblings' => '@nav-primary-siblings-*',
            ...
            'hover' => '.uk-nav',
            'inspect' =>
                '.uk-nav, .uk-nav > *, .uk-nav > * > *, .uk-nav-sub, .uk-nav-sub > *, .uk-nav-sub > * > *, .uk-nav-parent-icon, .uk-nav-parent-icon > svg',
        ],
        'navbar' => [
            'name' => 'Navbar',
            'groups' => [
                ...
                'container expand' => '@navbar-container-expand-*',
            ...
            'inspect' =>
                '.uk-navbar-container, .uk-navbar, .uk-navbar-left, .uk-navbar-right, .uk-navbar-center, .uk-navbar-nav, .uk-navbar-nav > *, .uk-navbar-nav > * > *, .uk-navbar-item, .uk-navbar-item > *, .uk-navbar-toggle, .uk-navbar-toggle > *, .uk-navbar-subtitle, .uk-navbar-dropbar, .uk-navbar-dropdown, .uk-navbar-dropdown-nav, .uk-navbar-dropdown-nav > *, .uk-navbar-dropdown-nav > * > *, .uk-navbar-toggle-icon, .uk-navbar-toggle-icon > svg',
        ],
        'notification' => [
            'name' => 'Notification',
            'groups' => [
            ...
            'inspect' =>
                '.uk-notification, .uk-notification-message, .uk-notification-message > *, .uk-notification-close',
        ],
        'offcanvas' => [
            'name' => 'Offcanvas',
            'groups' => [
            ...
            'hover' => '.uk-offcanvas',
            'inspect' =>
                '.uk-offcanvas, .uk-offcanvas-overlay, .uk-offcanvas-bar, .uk-offcanvas-bar > *',
        ],
        'overlay' => [
            'name' => 'Overlay',
            'groups' => [
        ...
        'pagination' => [
            ...
            'groups' => [
                ...
                'item next previous' => '@pagination-item-next-previous-*',
            ],
            'hover' => '.uk-pagination',
            'inspect' =>
                '.uk-pagination, .uk-pagination > *, .uk-pagination > * > *, .uk-pagination-next, .uk-pagination-next svg, .uk-pagination-previous, .uk-pagination-previous svg',
        ],
        'placeholder' => [
            'name' => 'Placeholder',
        ...
        'search' => [
            ...
            'hover' => '.uk-search',
            'inspect' =>
                '.uk-search, .uk-search-input, .uk-search-toggle, .uk-search-icon, .uk-search-icon svg',
        ],
        'section' => [
            'name' => 'Section',
            'groups' => [
        ...
        'sortable' => [
            ...
            'hover' => '.uk-sortable',
            'inspect' =>
                '.uk-sortable, .uk-sortable > *, .uk-sortable > * > *, .uk-sortable-drag, .uk-sortable-drag > *, .uk-sortable-placeholder, .uk-sortable-placeholder > *, .uk-sortable-empty, .uk-sortable-empty > *',
        ],
        'spinner' => [
            'name' => 'Spinner',
            'hover' => '.uk-spinner',
        ...
        'tab' => [
            ...
            'groups' => [
                'item' => '@tab-item-*',
                'item line' => '@tab-item-line-(?!height)*',
        ...
        'table' => [
            ...
            'hover' => '.uk-table',
            'inspect' =>
                '.uk-table, .uk-table th, .uk-table th > *, .uk-table td, .uk-table td > *,  .uk-table tr, .uk-table tbody, .uk-table thead, .uk-table tfoot, .uk-table caption',
        ],
        'text' => [
            'name' => 'Text',
            'groups' => [
        ...
        'thumbnav' => [
            ...
            'groups' => [
                'item' => '@thumbnav-item-*',
                'siblings' => '@thumbnav-siblings-*',
            ],
            'hover' => '.uk-thumbnav',
            'inspect' =>
                '.uk-thumbnav, .uk-thumbnav > *, .uk-thumbnav > * > *, .uk-thumbnav > * > * > *',
        ],
        'tile' => [
            'name' => 'Tile',
            'groups' => [
        ...
        'utility' => [
            ...
            'inspect' =>
                '.uk-panel-scrollable, .uk-panel-scrollable > *, .uk-box-shadow-bottom, .uk-dropcap, .uk-logo, .uk-logo > *',
        ],
        'width' => [
            'name' => 'Width',
            'hover' =>
                '.uk-width-small, .uk-width-medium, .uk-width-large, .uk-width-xlarge, .uk-width-2xlarge',
            'inspect' =>
                '.uk-width-small, .uk-width-small > *, .uk-width-medium, .uk-width-medium > *, .uk-width-large, .uk-width-large > *, .uk-width-xlarge, .uk-width-xlarge > *, .uk-width-2xlarge, .uk-width-2xlarge > *',
        ],
    ],
    'types' => [
        [
        ...
        [
            'type' => 'select-custom',
            'vars' => '*accordion-default-item-mode',
            'options' => [
                'Divider' => 'divider',
                'Item' => 'item',
                'Title' => 'title',
        ...
        [
            'type' => 'select-custom',
            'vars' => ['*nav-default-item-mode', '*nav-primary-item-mode'],
            'options' => [
                'None' => '',
                'Line' => 'line',
            ],
        ...
        [
            'type' => 'select-custom',
            'vars' => ['*navbar-nav-item-line-mode', '*navbar-nav-item-line-active-mode'],
            'options' => [
                'Enable' => 'true',
                'Disable' => 'false',
            ],
        ...
        [
            'type' => 'checkbox',
            'vars' => ['*-em-dash', '*navbar-container-padding'],
            'attrs' => [
                'false-value' => 'false',
                'true-value' => 'true',
            ],
