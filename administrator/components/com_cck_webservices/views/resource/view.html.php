...
// View
class CCK_WebservicesViewResource extends JCckBaseLegacyViewForm
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function prepareDisplay()
	{
		...
		Helper_Admin::addToolbarEdit( $this->vName, _C3_TEXT, array( 'isNew'=>$this->isNew, 'checked_out'=>$this->item->checked_out, 'layout'=>$this->getLayout() ) );
	}
}
?>