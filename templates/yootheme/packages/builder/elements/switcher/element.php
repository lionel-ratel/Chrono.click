...
return [
    ...
    'fields' => [
        ...
        'switcher_animation' => [
            'label' => 'Animation',
            'description' =>
                'Select an animation that will be applied to the content items when toggling between them.',
            'type' => 'select',
            'options' => [
                'None' => '',
                'Fade' => 'fade',
        ...
        'nav' => [
            'label' => 'Navigation',
            'description' =>
                'Select the navigation type. The pill and divider styles are only available for horizontal Subnavs.',
            'type' => 'select',
            'options' => [
                'Tabs' => 'tab',
        ...
        'nav_position' => [
            'label' => 'Position',
            'description' =>
                'Position the navigation at the top, bottom, left or right. A larger style can be applied to left and right navigations.',
            'type' => 'select',
            'options' => [
                'Top' => 'top',
                'Bottom' => 'bottom',
        ...
        'nav_grid_width' => [
            'label' => 'Grid Width',
            'description' =>
                'Define the width of the navigation. Choose between percent and fixed widths or expand columns to the width of their content.',
            'type' => 'select',
            'options' => [
                'Auto' => 'auto',
                '50%' => '1-2',
        ...
        'image_box_decoration_inverse' => [
            ...
            'text' => 'Inverse style',
            'enable' =>
                'show_image && $match(image_box_decoration, \'^(default|primary|secondary)$\')',
        ],
        'image_svg_inline' => [
            'label' => 'Inline SVG',
            'description' =>
        ...
        'css' => [
            'label' => 'CSS',
            'description' =>
                'Enter your own custom CSS. The following selectors will be prefixed automatically for this element: <code>.el-element</code>, <code>.el-item</code>, <code>.el-nav</code>, <code>.el-title</code>, <code>.el-meta</code>, <code>.el-content</code>, <code>.el-image</code>, <code>.el-link</code>',
            'type' => 'editor',
            'editor' => 'code',
            'mode' => 'css',
            'attrs' => [
