...
return [
    ...
    'fields' => [
        ...
        'title' => [
            'label' => 'Title',
            'description' =>
                'Enter a decorative section title which is aligned to the section edge.',
            'source' => true,
        ],
        'style' => [
            'label' => 'Style',
        ...
        'sticky' => [
            'label' => 'Sticky Effect',
            'description' =>
                'Sticky section will be covered by the following section while scrolling. Reveal section by previous section.',
            'type' => 'select',
            'options' => [
                'None' => '',
                'Cover' => 'cover',
        ...
        'animation' => [
            'label' => 'Animation',
            'description' =>
                'Apply an animation to elements once they enter the viewport. Slide animations can come into effect with a fixed offset or at 100% of the element size.',
            'type' => 'select',
            'options' => [
                'None' => '',
                'Fade' => 'fade',
        ...
        'css' => [
            'label' => 'CSS',
            'description' =>
                'Enter your own custom CSS. The following selectors will be prefixed automatically for this element: <code>.el-section</code>',
            'type' => 'editor',
            'editor' => 'code',
            'mode' => 'css',
            'attrs' => [
