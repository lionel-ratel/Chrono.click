...
return [
    ...
    'fields' => [
        ...
        'content_display' => [
            'label' => 'Show Content',
            'description' =>
                'Display the content inside the panel, as the lightbox caption or both.',
            'type' => 'select',
            'options' => [
                'Panel + Lightbox' => '',
                'Panel only' => 'item',
        ...
        'panel_link_hover' => [
            ...
            'enable' =>
                'show_link && panel_link && $match(panel_style, \'card-(default|primary|secondary|overlay)|tile-\')',
        ],
        'panel_padding' => [
            'label' => 'Padding',
        ...
        'panel_image_no_padding' => [
            'description' =>
                'Top, left or right aligned images can be attached to the panel edge. If the image is aligned to the left or right, it will also extend to cover the whole space.',
            'type' => 'checkbox',
        ...
        'image_box_decoration_inverse' => [
            ...
            'text' => 'Inverse style',
            'enable' =>
                '(show_image || show_video) && !panel_style && $match(image_box_decoration, \'^(default|primary|secondary)$\')',
        ],
        'image_link' => [
            'label' => 'Link',
        ...
        'image_hover_box_shadow' => [
            ...
            'enable' =>
                'show_link && (show_image || show_video) && !panel_style && (image_link || panel_link)',
        ],
        'image_align' => [
            'label' => 'Alignment',
            'description' =>
        ...
        'image_grid_column_gap' => [
            ...
            'enable' =>
                '(show_image || show_video) && $match(image_align, \'left|right\') && !(panel_image_no_padding && panel_style)',
        ],
        'image_grid_row_gap' => [
            'label' => 'Grid Row Gap',
            'description' => 'Set the size of the gap if the grid items stack.',
        ...
        'css' => [
            'label' => 'CSS',
            'description' =>
                'Enter your own custom CSS. The following selectors will be prefixed automatically for this element: <code>.el-element</code>, <code>.el-nav</code>, <code>.el-item</code>, <code>.el-title</code>, <code>.el-meta</code>, <code>.el-content</code>, <code>.el-image</code>, <code>.el-link</code>, <code>.el-hover-image</code>',
            'type' => 'editor',
            'editor' => 'code',
            'mode' => 'css',
            'attrs' => [
