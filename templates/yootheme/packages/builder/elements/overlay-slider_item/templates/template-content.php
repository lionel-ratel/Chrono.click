...
$title = $this->el($element['title_element'], [
    ...
    'class' => [
        ...
        'uk-transition-{title_transition} {@overlay_display}',
...
$meta = $this->el($element['meta_element'], [
    ...
    'class' => [
        'el-meta',
        'uk-transition-{meta_transition} {@overlay_display}',
        'uk-{meta_style}',
        'uk-text-{meta_color}',
...
$content = $this->el('div', [
    ...
    'class' => [
        'el-content uk-panel',
        'uk-transition-{content_transition} {@overlay_display}',
        'uk-{content_style}',
...
$link_container = $this->el('div', [
    ...
    'class' => [
        ...
        'uk-transition-{link_transition} {@overlay_display}', // Not on link element to prevent conflicts with link style
    ],
