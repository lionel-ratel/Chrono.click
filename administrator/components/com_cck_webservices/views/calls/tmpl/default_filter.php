...
$clear	=	"document.getElementById('filter_state').value='-1';document.getElementById('filter_webservice').value='';";
if ( $this->js['filter'] ) {
...
<div class="<?php echo $this->css['filter']; ?>" id="filter-bar">
	...
	<div class="<?php echo $this->css['filter_select']; ?>">
		...
		echo JCckDev::getForm( 'more_webservices_call_webservice', $this->state->get( 'filter.webservice' ), $config, array( 'selectlabel'=>'All Webservices', 'storage_field'=>'filter_webservice', 'attributes'=>'onchange="this.form.submit()"' ) );
