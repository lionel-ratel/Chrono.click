...
// Script
class com_cck_exporterInstallerScript extends JCckInstallerScriptComponent
{
	protected $cck;
	protected $cck_title	=	'Exporter';
	protected $cck_name		=	'cck_exporter';
	...
	public function postflight( $type, $parent )
	{
		...
		if ( version_compare( $v, '2.0.5', '<' ) ) {
			...
			Factory::getApplication()->enqueueMessage( 'SEBLOD 2.1.0 (or >) is required.', 'error' );
		} else {
