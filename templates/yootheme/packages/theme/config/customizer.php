...
return [
    '@import' => [
        __DIR__ . '/../../builder/config/customizer.php',
        __DIR__ . '/../../styler/config/customizer.php',
        __DIR__ . '/../../theme-consent/config/customizer.php',
        __DIR__ . '/../../theme-settings/config/customizer.php',
    ],
        ...
        'site' => [
            ...
            'fields' => [
                ...
                'logo.image_svg_inline' => [
                    'description' =>
                        'Select your logo. Optionally inject an SVG logo into the markup so it adopts the text color automatically.',
                    'type' => 'checkbox',
                ...
                'logo.image_inverse' => [
                    ...
                    'description' =>
                        'Select an alternative logo with inversed color, e.g. white, for better visibility on dark backgrounds. It will be displayed automatically, if needed.',
                    'type' => 'image',
                ],
                'logo.image_mobile' => [
                    'label' => 'Mobile Logo (Optional)',
                    'description' =>
                        'Select an alternative logo, which will be used on small devices.',
                    'type' => 'image',
                ],
                ...
                'logo.image_dialog' => [
                    ...
                    'description' =>
                        'Select a logo, which will be shown in offcanvas and modal dialogs of certain header layouts.',
                    'type' => 'image',
                ],
                ...
                'site.breadcrumbs_show_home' => [
                    'description' =>
                        'Show or hide the home link as first item as well as the current page as last item in the breadcrumb navigation.',
                    'text' => 'Show home link',
                    'type' => 'checkbox',
                    'enable' => 'site.breadcrumbs',
                ],
                ...
                'site.main_section.height' => [
                    ...
                    'description' =>
                        'On short pages, the main section can be expanded to fill the viewport. This only applies to pages which are not build with the page builder.',
                    'text' => 'Expand height',
                    'type' => 'checkbox',
                ],
            ],
        ...
        'site-media' => [
            ...
            'fields' => [
                'site._image_dimension' => [
                    'type' => 'grid',
                    'description' =>
                        'Set the width and height in pixels (e.g. 600). Setting just one value preserves the original proportions. The image will be resized and cropped automatically.',
                    'width' => '1-2',
                    'fields' => [
                        'site.image_width' => [
                            'label' => 'Width',
                ...
                'site.image_size' => [
                    'label' => 'Image Size',
                    'description' =>
                        'Determine whether the image will fit the page dimensions by clipping it or by filling the empty areas with the background color.',
                    'type' => 'select',
                    'options' => [
                        'Auto' => '',
                        'Cover' => 'cover',
                ...
                'site.image_position' => [
                    ...
                    'description' =>
                        'Set the initial background position, relative to the page layer.',
                    'type' => 'select',
                    'options' => [
                        'Top Left' => 'top-left',
                        'Top Center' => 'top-center',
                ...
                'site.image_parallax_easing' => [
                    ...
                    'description' =>
                        'Set the animation easing. Zero transitions at an even speed, a negative value starts off quickly while a positive value starts off slowly.',
                    'type' => 'range',
                    'attrs' => [
                        'min' => -2,
                        'max' => 2,
                ...
                'site.media_blend_mode' => [
                    'label' => 'Blend Mode',
                    'description' =>
                        'Determine how the image will blend with the background color.',
                    'type' => 'select',
                    'options' => [
                        'Normal' => '',
                        'Multiply' => 'multiply',
        ...
        'header' => [
            ...
            'fields' => [
                'header.layout' => [
                    'label' => 'Layout',
                    'description' =>
                        'Select the layout for the <code>logo</code>, <code>navbar</code> and <code>header</code> positions. Some layouts can split or push items of a position which are shown as ellipsis.',
                ...
                'header.split_index' => [
                    'label' => 'Split Items',
                    'description' =>
                        'The logo is placed automatically between the items. Optionally, set the number of items after which the items are split.',
                    'type' => 'select',
                    'options' => [
                        'Auto' => '',
                        'After 1 Item' => 1,
                ...
                'header.push_index' => [
                    'label' => 'Push Items',
                    'description' =>
                        'Set the number of items after which the following items are pushed to the right.',
                    'type' => 'select',
                    'options' => [
                        'None' => '',
                        'After 1 Item' => 1,
                ...
                'header.logo_padding_remove' => [
                    ...
                    'enable' =>
                        'header.width == \'expand\' && !$match(header.layout, \'^stacked|^horizontal-center-logo\')',
                ],
                'navbar.sticky' => [
                    'label' => 'Navbar',
                    'description' =>
                        'Stick the navbar at the top of the viewport while scrolling or only when scrolling up.',
                    'type' => 'select',
                    'options' => [
                        'Static' => 0,
                        'Sticky' => 1,
                ...
                'navbar.dropdown_preserve_color' => [
                    'type' => 'checkbox',
                ...
                'navbar.dropdown_click' => [
                    'description' =>
                        'Align dropdowns to their menu item or the navbar. Optionally, show them in a full-width section called dropbar, display an icon to indicate dropdowns and let text items open by click and not hover.',
                    'type' => 'checkbox',
                ...
                'dialog._description' => [
                    'description' =>
                        'Select the layout for the <code>dialog</code> position. Items which can be pushed are shown as ellipsis.',
                    'type' => 'description',
                ],
                'dialog.push_index' => [
                    'label' => 'Dialog Push Items',
                    'description' =>
                        'Set the number of items after which the following items are pushed to the bottom.',
                    'type' => 'select',
                    'options' => [
                        'None' => '',
                        'After 1 Item' => 1,
                ...
                'header.search_expand' => [
                    ...
                    'enable' =>
                        'header.search && !$match(header.search, \'^dialog\') && $match(header.search_layout, \'^input-\') && $match(header.layout, \'^horizontal-(left|center|right|justify)|stacked-(left|justify)$\')',
                ],
                ...
                'header.search_description' => [
                    'description' =>
                        'Show an input field or an icon to open the search in a dropdown, dropbar or modal. To show live search results, assign a template in the Templates panel.',
                    'type' => 'description',
                ],
                'header.search_icon' => [
                    'label' => 'Search Icon',
        ...
        'dialog-dropbar' => [
            ...
            'fields' => [
                'dialog.dropbar.animation' => [
                    ...
                    'description' =>
                        'Select the animation on how the dropbar appears below the navbar.',
                    'type' => 'select',
                    'options' => [
                        'Fade' => '',
                ...
                'dialog.dropbar.width' => [
                    'label' => 'Dropbar Width',
                    'description' =>
                        'Set the dropbar width if it slides in from the left or right.',
                    'type' => 'select',
                    'options' => [
                        'None' => '',
                        'Medium' => 'medium',
                ...
                'header.social_items' => [
                    ...
                    'fields' => [
                        ...
                        'image' => [
                            'label' => 'Image',
                            'description' =>
                                'Pick an alternative SVG image from the media manager.',
                            'type' => 'image',
                            'enable' => '!icon',
                        ],
                    ],
        ...
        'mobile' => [
            ...
            'fields' => [
                ...
                'mobile.header.layout' => [
                    'label' => 'Layout',
                    'description' =>
                        'Select the layout for the <code>logo-mobile</code>, <code>navbar-mobile</code> and <code>header-mobile</code> positions.',
                ...
                'mobile.dialog._description' => [
                    'description' =>
                        'Select the layout for the <code>dialog-mobile</code> position. Pushed items of the position are shown as ellipsis.',
                    'type' => 'description',
                    'show' => 'mobile.breakpoint',
                ],
                ...
                'mobile.header.search_expand' => [
                    ...
                    'show' => 'mobile.breakpoint',
                    'enable' =>
                        'mobile.header.search && !$match(mobile.header.search, \'^dialog\') && $match(mobile.header.search_layout, \'^input-(dropdown|dropbar)$\') && $match(mobile.header.layout, \'^horizontal-(left|center|right)$\')',
                ],
        ...
        'top' => [
            ...
            'fields' => [
                ...
                'top.text_color' => [
                    ...
                    'enable' => '!top.style || top.image || top.video',
                ],
                'top.width' => [
                    'label' => 'Max Width',
                ...
                'top.height_offset_top' => [
                    'description' =>
                        'Set a fixed height, and optionally subtract the header height to fill the first visible viewport. Alternatively, expand the height so the next section also fits the viewport, or on smaller pages to fill the viewport.',
                    'type' => 'checkbox',
                ...
                'top.header_transparent_noplaceholder' => [
                    'description' =>
                        'Make the header transparent and overlay this section if it directly follows the header.',
                    'type' => 'checkbox',
        ...
        'sidebar' => [
            ...
            'fields' => [
                ...
                'main_sidebar.breakpoint' => [
                    'label' => 'Breakpoint',
                    'description' =>
                        'Set the breakpoint from which the sidebar and content will stack.',
                    'type' => 'select',
                    'options' => [
                        'Small (Phone Landscape)' => 's',
                        'Medium (Tablet Landscape)' => 'm',
        ...
        'bottom' => [
            ...
            'fields' => [
                ...
                'bottom.text_color' => [
                    ...
                    'enable' => '!bottom.style || bottom.image || bottom.video',
                ],
                'bottom.width' => [
                    'label' => 'Max Width',
                    'description' => 'Set the maximum content width.',
                ...
                'bottom._height' => [
                    'label' => 'Height',
                    'description' =>
                        'Set a fixed height. Alternatively, expand the height so the next section also fits the viewport, or on smaller pages to fill the viewport.',
                    'type' => 'grid',
                    'width' => '3-4,1-4',
                    'gap' => 'small',
                    'fields' => [
